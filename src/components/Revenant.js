...
import img1 from '../Assets/revenant.jpg';
import img2 from '../Assets/ArtRevenant.jpg';
      ...
      <div id="center">
        <Fade bottom distance="20%" duration={1500}>
          <a href="#" onClick={handleClick}  >
            <h1 id="text" >
              <a href='#' onClick={handleClick}>REVENANT</a>
            </h1>
          </a>
          {info && (
            <Fade bottom distance="20%" duration={1500}>
              <Card sx={{ backgroundImage: `url(${img2})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', boxShadow: 'revert-layer' }}>
                ...
                <CardContent sx={{ color: 'white' }}>
                  <Typography variant="body1">
                    ...
                    <a style={{color:'white',backgroundColor:'black'}} href='https://youtu.be/LoebZZ8K5N0' target='_blank'>CLICK TO WATCH TRAILER</a>
